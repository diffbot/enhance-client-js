...
* <pre>
* var EnhanceClient = require('com.diffbot.kg.enhance.openapi.invoker/index'); // See note below*.
* var xxxSvc = new EnhanceClient.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new EnhanceClient.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new EnhanceClient.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new EnhanceClient.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
