...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiffbotEnhanceService.BulkjobStatusResponse();
  });
  ...
  describe('BulkjobStatusResponse', function() {
    it('should create an instance of BulkjobStatusResponse', function() {
      // uncomment below and update the code to test BulkjobStatusResponse
      //var instane = new DiffbotEnhanceService.BulkjobStatusResponse();
      //expect(instance).to.be.a(DiffbotEnhanceService.BulkjobStatusResponse);
    });
