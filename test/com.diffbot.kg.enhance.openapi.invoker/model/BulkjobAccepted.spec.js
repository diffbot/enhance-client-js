...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiffbotEnhanceService.BulkjobAccepted();
  });
  ...
  describe('BulkjobAccepted', function() {
    it('should create an instance of BulkjobAccepted', function() {
      ...
      //var instane = new DiffbotEnhanceService.BulkjobAccepted();
      //expect(instance).to.be.a(DiffbotEnhanceService.BulkjobAccepted);
    });
