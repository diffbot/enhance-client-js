...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiffbotEnhanceService.RequestError();
  });
  ...
  describe('RequestError', function() {
    it('should create an instance of RequestError', function() {
      ...
      //var instane = new DiffbotEnhanceService.RequestError();
      //expect(instance).to.be.a(DiffbotEnhanceService.RequestError);
    });
