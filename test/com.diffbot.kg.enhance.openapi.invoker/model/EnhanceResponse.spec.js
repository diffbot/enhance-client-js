...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiffbotEnhanceService.EnhanceResponse();
  });
  ...
  describe('EnhanceResponse', function() {
    it('should create an instance of EnhanceResponse', function() {
      ...
      //var instane = new DiffbotEnhanceService.EnhanceResponse();
      //expect(instance).to.be.a(DiffbotEnhanceService.EnhanceResponse);
    });
